// When user clicks the start button, a timer starts and the quiz begins
...
var questionsArray = [
{
    ...
    imageSrc: "",
    answerChoice: ["A. Hypertext Link", "B. Hypertext Markup Language", "C. Hyperspeed Text", "D. Nothing"],
    correctAnswer: 1
}, 
{
    question: "Question: What are variables used for in JavaScript Programs?",
    imageSrc: "",
    answerChoice: ["A. Storing numbers, dates, or other values", "B. Varying randomly", "C. Causing high-school algebra flashbacks", "D. None of the above"],
    correctAnswer: 0
},
{
    question: "Question: What does CSS stand for?",
    imageSrc: "",
    answerChoice: ["A. Color Style Sheets", "B. Coloring Sheets Style ", "C. Cascading Style Sheets ", "D. Cascading Service Sheets"],
    correctAnswer: 2
}, 
{
